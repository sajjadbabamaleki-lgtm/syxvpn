      ...
      {created ? (
        <div className="result">
          ...
          <p className="warn-note">
            ...
            <code> SYXVPN_AGENT_KEY</code> and keep it out of shell history.
          </p>
          <code className="token-box">{created.agentKey}</code>
          <CopyButton value={created.agentKey} label="Copy agent key" />
          <code className="token-box">SYXVPN_GATEWAY_ID={created.id}</code>
        ...
        <form className="form" onSubmit={submit}>
          ...
          {reality ? (
            ...
            <>
              <Field label="TLS" hint="SyxVPN will not advertise TLS a gateway cannot actually serve">
