...
import pro.syxvpn.app.SyxVpnApp
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        askForNotifications()
        val app = application as SyxVpnApp
        setContent {
            cVPNTheme {
                cVPNRoot(
                    app = app,
    ...
    private fun startTunnel(request: PendingConnect?) {
        ...
        val controlHosts = (application as SyxVpnApp).endpoints.ordered()
        ...
        startService(
            Intent(this, TunnelService::class.java)
                ...
                .putExtra(
                    ...
                    (application as SyxVpnApp).session.purposeName,
                )
                ...
                .putExtra(
                    ...
                    (application as SyxVpnApp).session.dnsMode.name,
                ),
        )
    }
    ...
    private fun openStore() {
        startActivity(
            Intent(Intent.ACTION_VIEW, Uri.parse((application as SyxVpnApp).endpoints.current())),
        )
    }
