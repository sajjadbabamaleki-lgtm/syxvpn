...
#   CONTROL_URL   control plane base URL         (default https://control.syxvpn.pro)
#   GATEWAY_HOST  the address clients dial       (default gw1.syxvpn.pro)
...
CONTROL_URL=${CONTROL_URL:-https://control.syxvpn.pro}
GATEWAY_HOST=${GATEWAY_HOST:-gw1.syxvpn.pro}
...
# Everything this run owns is named after the host's first label — gw2.syxvpn.pro
...
SYXVPN_URL=$CONTROL_URL
SYXVPN_GATEWAY_ID=$GW
SYXVPN_AGENT_KEY=$AGENT_KEY
ENV
)
...
BLOCK=/etc/caddy/syxvpn-$GATEWAY_NAME.caddy
