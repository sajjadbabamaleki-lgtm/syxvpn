...
SyxVPN sells and operates managed access to authorized proxy infrastructure.
...
and it cannot create a path that does not exist. SyxVPN is built around that
distinction:
...
SyxVPN routes only through connectivity the operator already has and is
